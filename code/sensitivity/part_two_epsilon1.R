...
# Save objects
save(extincts_full, extincts_full_less_one, final_Ns, equil_noDis_Ns, R0_less_one, should_be_extinct, file = "~/marketVirEvol/code_output/obj/extincts_epsilon1.RData")
...
# Around 0.06% have R0 strictly less than 1
