...
# Save objects
save(opt_mm_res, R0_mm_res, flat_mm_res, inc_mm_res, diff_virs_1, file = "~/marketVirEvol/code_output/obj/mm_dens_epsilon1.RData")
load("~/marketVirEvol/code_output/obj/mm_dens_epsilon1.RData")
# Percent of discarded parameter sets
exclude_beta_cnt / (length(c1_range) * length(c2_range))
# Q0 result: false, there is another optimum in this model due to greater persistence
all(opt_mm_res)
...
# Save objects
save(opt_psi_res, R0_psi_res, flat_psi_res, inc_psi_res, diff_virs_2, file = "~/marketVirEvol/code_output/obj/psi_dens_epsilon1.RData")
load("~/marketVirEvol/code_output/obj/psi_dens_epsilon1.RData")
