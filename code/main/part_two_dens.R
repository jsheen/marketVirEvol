...
# Save objects
save(extincts_full, extincts_full_less_one, final_Ns, equil_noDis_Ns, R0_less_one, should_be_extinct, file = "~/marketVirEvol/code_output/obj/extincts_dens.RData")
load("~/marketVirEvol/code_output/obj/extincts_dens.RData")
